...
namespace Novin.Pirast.Core.Entities.Customer
{
    public class NormalUser : Thing
    {
        ...
        //public string? CustomerAddress { get; set; }Ezafe
        ...
        //public string? CustomerDiscount { get; set; }Ezafe barye khode site
        public required List<Ticket> CustomerTicket { get; set; }
